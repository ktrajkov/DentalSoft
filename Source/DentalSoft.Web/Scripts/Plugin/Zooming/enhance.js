+function ($) { "use strict";
  ...
  Zoom.prototype.zoomImage = function () {
    ...
    img.onload = $.proxy(function () {
        this._fullHeight = Number(img.height) //Zoom height
      this._fullWidth = Number(img.width) //Zoom width
      this._zoomOriginal()
    }, this)
    img.src = this._targetImage.src
    Zoom.IMAGEWIDTH = this._targetImage.width
  }
  ...
  Zoom.prototype.dispose = function () {
    if (this._targetImageWrap && this._targetImageWrap.parentNode) {
      $(this._targetImage)
        ...
        .css({'width':Zoom.IMAGEWIDTH,'height': '', 'transform': ''})
